...
/*Devuelve una columna (array unidimensional) de un array bidimensional
que se pasa como parámetro.*/
public class Ej11ConvColumnaAArray {
    
    /*Funcion que convierte una matriz en un array*/
    static int[] Conversion(int matriz[][],int j) {
        ...
        for (int i = 0; i < cont; i++) { // Bucle para recorrer la matriz y encuantre la columna para luego escribir en el array
                array[r] = matriz[i][j];
                r++;
        }
    ...
    public static void main(String[] args) {
        ...
        int array[] = Conversion(matriz,columna); // Guardamos el array de la funcion hecha
